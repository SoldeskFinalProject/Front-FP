...
import { getVerificationRequests, approveRequest, rejectRequest } from "../../api/authAPI"
...
const AdminVerificationPage = () => {
    ...
    const fetchRequests = useCallback(async () => {
        try {
            ...
            const data = await getVerificationRequests(type, filterDecision)
            setRequests(data)
        } catch (error) {
    ...
    //     }
    //     fetchRequests()
    // }, [isAdmin, navigate, fetchRequests])
    ...
    return (
        ...
        <div className="filter-section">
            ...
            <label className="filter-label">요청 유형</label>
            <div className="filter-buttons">
                ...
                onClick={() => setFilterType("DOCTOR")}>의사</button>
                <button
                className={`filter-btn ${filterType === "HOSPITAL" ? "active" : ""}`}
                onClick={() => setFilterType("HOSPITAL")}>병원</button>
            </div>
            </div>
